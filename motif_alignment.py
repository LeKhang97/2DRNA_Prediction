...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(description ='This tool is used to align motif :))')
	...
	parser.add_argument('-s',
        	        '--sequence',
			 help ='target sequence. Can be input from terminal from file')
	...
	if args.verbose:
		...
		print("Number of used threads: ", args.threads , sep = '', end = '\n\n')
